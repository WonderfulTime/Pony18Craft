...
public class PivoBlock extends HorizontalFacingBlock {


    public static final DirectionProperty FACING = Properties.HORIZONTAL_FACING;

    public PivoBlock(Settings settings) {
        super(settings);
    }
     ...
     */
    public static VoxelShape SHAPE = Block.createCuboidShape(6, 0, 6, 10, 16, 10);
